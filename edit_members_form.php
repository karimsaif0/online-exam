<div class="row-fluid">				  
   <a href="add_members.php" class="btn btn-info" id="add" data-placement="right" title="Click to Add New" ><i class="icon-plus-sign icon-large"></i> Add New Examinee</a>
	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i> Edit Examinee Info.</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = mysql_query("select * from teens where id = '$get_member_id'")or die(mysql_error());
					...
					<div class="control-group">
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="department" id="focusedInput" value="<?php echo $row['department']; ?>" type="text" placeholder = "Department" required> 
                                   </p>
                                 </div>
                                  </div>
								  </p>
...
mysql_query("UPDATE teens SET fname = '$fname',sname ='$sname',lname='$lname',Gender='$Gender',department='$department',email='$email',mobile='$mobile' where id='$get_member_id'") 
or die(mysql_error());
...
<script>
 ...
 $.jGrowl(" Examinee Successfully Update", { header: 'Examinee Update' });  
</script>
<?php
}
?>
