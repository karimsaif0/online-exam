    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_offering_form.php'); ?>		   			
				</div>
				<?php	
					...
					<div class="empty">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-user"></i>  Exam(s) List</div>
								...
								<form action="delete_offering.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
                                                ...
                                                <td><?php echo $row['valueoptions']; ?></td>
												<td><?php echo $row['valueoptionsb']; ?></td>
												<td><?php echo $row['valueoptionsc']; ?></td>
												<td><?php echo $row['valueoptionsd']; ?></td>
												<td><?php echo $row['questionanswer']; ?></td>
											
												<?php include('toolttip_edit_delete.php'); ?>															
												<td width="120">
												<a rel="tooltip"  title="Edit Question" id="e<?php echo $id; ?>" href="edit_offering.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit Info</i></a>
												</td>
